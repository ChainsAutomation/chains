...
class TestBaseConfigYml(unittest.TestCase):
...
'''
  ...
  def test_When_creating_empty_config_It_has_correct_type_and_empty_data(self):
    testBaseConfig = BaseConfig()
    self.assertIsInstance(BaseConfig(), type(testBaseConfig))
